...
<tr>
<td class="tl"><a href="<?php echo DT_PATH;?>api/redirect.php?url=www.alipay.com" target="_blank" class="t"><strong>支付宝手机支付 Alipay</strong></a></td>
<td>
...
<input type="radio" name="pay[weixin][enable]" value="0"  <?php if(!$weixin['enable']) echo 'checked';?> onclick="Dd('weixin').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo DT_PATH;?>api/redirect.php?url=https://pay.weixin.qq.com/" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
