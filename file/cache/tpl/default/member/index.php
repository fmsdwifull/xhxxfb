...
<div id="warn">
<?php if($_groupid == 4) { ?>
<div class="warn">尊敬的会员，您的帐号<span class="f_red">正在审核中..</span>，本站部分功能和服务可能受到一定的使用限制，<?php if($MOD['checkuser']==2) { ?><a href="send.php?action=check" class="l">请点这里验证您的邮箱</a>，系统将自动审核<?php } else { ?>请稍候，等待网站审核<br/>完善的商业信息有助于获得别人的信任，结交潜在的商业伙伴，获取商业机会，增加系统审核通过的概率&nbsp;&nbsp;<a href="edit.php?tab=2" class="t">现在就去完善&raquo;</a><?php } ?>
</div>
<?php } ?>
...
<a href="cash.php" class="t">提现</a> <span class="f_gray">&nbsp;|&nbsp;</span> 
...
<td onclick="Go('<?php echo $MODULE['16']['linkurl'];?>cart.php');"><div>购物车</div><span><script type="text/javascript">document.write(get_cart());</script></span></td>
<?php } ?>
<td onclick="Go('message.php');"><div>新消息</div><span><?php echo $_message;?></span></td>
<?php if($DT['im_web']) { ?>
<td onclick="Go('chat.php');"><div>新对话</div><span><?php echo $_chat;?></span></td>
<?php } ?>
...
<?php } ?>
<td onclick="Go('<?php echo $DT['file_my'];?>');"><img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/icon_add.png" width="32" height="32"/><br/><span>发布信息</span></td>
...
<td onclick="Go('home.php');"><img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/icon_home.png" width="32" height="32"/><br/><span>商铺管理</span></td>
</tr>
</table>
</div>
<div class="ihead">
