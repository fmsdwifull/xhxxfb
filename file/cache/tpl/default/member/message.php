...
<table cellpadding="0" cellspacing="0">
<tr>
<td class="<?php if($typeid==-1) { ?>nav_2<?php } else { ?>nav_1<?php } ?>
"><a href="?action=<?php echo $action;?>">全部</a></td>
<?php if(is_array($NAME)) { foreach($NAME as $k => $v) { ?>
<td class="<?php if($typeid==$k) { ?>nav_2<?php } else { ?>nav_1<?php } ?>
"><a href="?action=<?php echo $action;?>&typeid=<?php echo $k;?>"><?php echo $v;?></a></td>
<?php } } ?>
</tr>
</table>
</div>
