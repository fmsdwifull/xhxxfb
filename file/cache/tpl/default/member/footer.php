<?php defined('IN_XHXXFB') or exit('Access Denied');?></td>
</tr>
</table>
</div>
<?php if($DT_TOUCH) { ?>
...
if(window.location.href.indexOf('message.php') == -1) $('#xhxxfb_space').html(sound('message_<?php echo $_sound;?>'));
<?php } ?>
<?php if($_chat) { ?>
if(window.location.href.indexOf('chat.php') == -1) $('#xhxxfb_space').html(sound('chat_new'));
<?php } ?>
<?php if($_message) { ?>
