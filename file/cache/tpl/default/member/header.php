<?php defined('IN_XHXXFB') or exit('Access Denied');?><?php if($DT_TOUCH) { ?>
<!DOCTYPE html>
<html>
<head>
...
个人中心<?php echo $DT['seo_delimiter'];?><?php if($city_sitename) { ?><?php echo $city_sitename;?><?php } else { ?><?php echo $DT['sitename'];?><?php } ?>
<?php echo $DT['seo_delimiter'];?>Powered By xhxxfb B2B</title>
<?php } ?>
...
<div class="head_m">
<div class="head_logo"><a href="<?php echo $MODULE['2']['linkurl'];?>"><img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/logo.png" alt="个人中心"/></a></div>
<div class="head_main">
<ul>
<?php if($_userid) { ?>
...
<li id="xhxxfb_message"><a href="message.php">消息</a><?php if($_message) { ?><em><?php echo $_message;?></em><?php } ?>
</li>
<?php if($DT['im_web']) { ?><li id="xhxxfb_chat"><a href="chat.php">对话</a><?php if($_chat) { ?><em><?php echo $_chat;?></em><?php } ?>
</li><?php } ?>
...
<div class="head_s" id="xhxxfb_space">&nbsp;</div>
<?php } ?>
<div class="main_tb">
