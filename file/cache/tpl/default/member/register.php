...
<span class="f_b">
&raquo; 已经是会员？请<a href="<?php echo $DT['file_login'];?>?forward=<?php echo urlencode($forward);?>" class="b">点这里登录</a>&nbsp;
&raquo; 忘记了密码？请<a href="send.php?forward=<?php echo urlencode($forward);?>" class="b">点这里找回</a>&nbsp;
<?php if($MOD['checkuser'] == 2) { ?>
&raquo; <span class="f_red">未收到验证信？</span>请<a href="send.php?action=check&forward=<?php echo urlencode($forward);?>" class="b">点这里重发</a>
<?php } ?>
</span>
<br/>
...
<tr>
<td class="tl">&nbsp;</td>
<td width="300"><input type="checkbox" checked="checked" onclick="if(this.checked){Ds('sbm');}else{Dh('sbm');}"/> <a href="?read=1" target="_blank" class="b">我已阅读并同意服务条款</a></td>
<td>&nbsp;</td>
</tr>
<tr id="sbm">
<td class="tl"></td>
<td>
<input type="submit" name="submit" value="立即注册" style="background:#77C019;color:#FFFFFF;font-size:14px;width:120px;line-height:32px;border:none;border-radius:4px;text-align:center;"/>
</td>
<td>&nbsp;</td>
</tr>
</table>
