<?php defined('IN_XHXXFB') or exit('Access Denied');?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<?php } ?>
<meta name="generator" content="xhxxfb B2B - www.xhxxfb.com"/>
...
<div class="head_m">
<div class="f_r" id="xhxxfb_member"></div>
<div class="head_l">
<ul>
<?php if($DT['city']) { ?><li class="h_city">[<span id="xhxxfb_city"><?php echo $city_name;?></span>] <a href="<?php echo DT_PATH;?>api/city.php" title="点击切换城市" rel="nofollow">切换</a></li><?php } ?>
...
<?php if(isset($MODULE['16'])) { ?><li class="h_cart"><a href="<?php echo $MODULE['16']['linkurl'];?>cart.php" rel="nofollow">购物车</a>(<span class="head_t" id="xhxxfb_cart">0</span>)</li><?php } ?>
</ul>
</div>
</div>
</div>
<?php if($head_mobile) { ?><div id="xhxxfb_qrcode" style="display:none;"></div><?php } ?>
<div class="m head_s" id="xhxxfb_space"></div>
...
<form id="xhxxfb_search" action="<?php echo $MODULE[$searchid]['linkurl'];?>search.php" onsubmit="return Dsearch(1);">
<input type="hidden" name="moduleid" value="<?php echo $searchid;?>" id="xhxxfb_moduleid"/>
<input type="hidden" name="spread" value="0" id="xhxxfb_spread"/>
<div class="head_search" onmouseover="this.className='head_search_on';" onmouseout="this.className='head_search';">
<div>
<input name="kw" id="xhxxfb_kw" type="text" class="search_i" value="<?php if($kw) { ?><?php echo $kw;?><?php } else { ?>请输入关键词<?php } ?>
" onfocus="if(this.value=='请输入关键词') this.value='';"<?php if($DT['search_tips']) { ?> onkeyup="STip(this.value);" autocomplete="off"<?php } ?>
 x-webkit-speech speech/><input type="text" id="xhxxfb_select" class="search_m" value="<?php echo $MODULE[$searchid]['name'];?>" readonly onfocus="this.blur();" onclick="$('#search_module').fadeIn('fast');"/><input type="submit" value=" " class="search_s"/>
</div>
</div>
</form>
<div class="head_search_kw f_l"><a href="" onclick="Dsearch_top();return false;"><strong>标王</strong></a> 
<a href="" onclick="Dsearch_adv();return false;"><strong>热搜：</strong></a>
<span id="xhxxfb_word"><?php echo tag("moduleid=$searchid&table=keyword&condition=moduleid=$searchid and status=3&pagesize=10&order=total_search desc&template=list-search_kw");?></span></div>
</div>
<div class="m">
<div class="menu">
